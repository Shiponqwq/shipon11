...
def banner():
	...
	au='AUTHOR    :  Shipon-MRS\nStatus    :  Premium\nWHATSAPP  :01773276144'

	pengembang1=nel(au,style="cyan")

	cetak(nel(pengembang1, title=''))
...
def login_lagi():
	...
	try:
		...
		___kontol___ = input('[•] Enter Cookies : ')
...
def menu(my_name,my_id):
	...
	io = '[01] Crack Of Public Friends\n[02] Crack Of Public Friends (Massal)\n[03] Cek Result Crack\n[04] Cek Opsi Checkpoint\n[00] Log Out'

	oi = nel(io, style='cyan')

	cetak(nel(oi, title=''))

	jh = input(x+'['+h+'•'+x+'] Choose : ')
...
def setting():
	...
	aplik = input(x+'╭─── Tampilkan Aplikasi Tertaut ? (y/t) : ')
	...
	osk = input(x+'╰─── Tampilkan Opsi Checkpoint? (y/t) : ')
